/**
 * Navbar Component - Shared across all public pages
 * 
 * Features:
 * - Logo + brand name
 * - Navigation links (Home, Search Hotels, etc.)
 * - Auth buttons (Sign In, Sign Up) or User menu
 * - Mobile responsive hamburger menu
 * - Support for authenticated/unauthenticated states
 * 
...
const Navbar = ({ 
  ...
  // Merge default and additional links
            ...
            >
              <div className="flex flex-col space-y-2">
                ...
                {!isAuthenticated && (
                  <Link
                    to="/login"
                    className="text-gray-700 hover:text-gray-900 font-medium py-2 md:hidden"
                    onClick={() => setIsMenuOpen(false)}
                  >
                    Sign In
                  </Link>
